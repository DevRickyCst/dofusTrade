...
class TestViews(TestCase):
    ...
    def test_login_view(self):
        ...
        response = self.client.post(self.login_url, {'username': 'wronguser', 'password': 'wrongpassword', 'current_page': '/login'})
    ...
    def test_logout_view(self):
        ...
        self.assertEqual(response.status_code, 200)  # Assuming '/' is your homepage

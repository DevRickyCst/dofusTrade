...
class Set(models.Model):
    ...
    caracteristique = models.ForeignKey(
        SetCaracteristique, on_delete=models.CASCADE, null=True, blank=True
    )
    stuff = models.ForeignKey(
        SetStuff, on_delete=models.CASCADE, null=True, blank=True
    )
    ...
    def __str__(self):
        return (
            ...
            + self.id.__str__()
            + "< characteristique_id: "
            + self.caracteristique.id.__str__()
            + ", stuff_id: "
            + self.stuff.id.__str__()
            + " >"
        )
